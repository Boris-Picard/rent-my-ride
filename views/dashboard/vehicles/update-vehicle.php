                ...
                <div class="col-12 p-0 rounded-4 shadow-lg bg-white">
                    <div class="row m-0 p-0">
                        ...
                        <div class="col-12 d-flex flex-column p-0 sidebar rounded colSidebar g-5">
                            ...
                            <a href="/controllers/dashboard/vehicles/add-vehicle-ctrl.php" class="py-3 nav-link active navLink sidebarLink"><span><i class="bi bi-car-front-fill px-3"></i>Véhicle</span></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form action="" method="POST" class="shadow-lg p-5 rounded-4" enctype="multipart/form-data" novalidate>
                                    ...
                                    <a href="/controllers/dashboard/vehicles/list-vehicles-ctrl.php" class="btn btn-outline-danger fw-bold text-uppercase">Annuler</a>
                                </form>
                            </div>
                        </div>
                    </div>
