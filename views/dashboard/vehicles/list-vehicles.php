                ...
                <div class="col-12 p-0 rounded-4 shadow-lg bg-white">
                    <div class="row m-0 p-0">
                        ...
                        <div class="col-12 d-flex flex-column p-0 sidebar rounded colSidebar g-5">
                            ...
                            <a href="/controllers/dashboard/vehicles/add-vehicles-ctrl.php" class="py-3 active nav-link navLink sidebarLink"><span><i class="bi bi-car-front-fill px-3"></i>Véhicle</span></a>
