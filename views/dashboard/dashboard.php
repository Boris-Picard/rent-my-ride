                ...
                <div class="col-md-12 col-4 p-0 rounded-4 shadow-lg bg-white">
                    <div class="row m-0 p-0">
                        ...
                        <div class="col--12 col-4 d-flex flex-column p-0 sidebar rounded colSidebar g-5">
                            ...
                            <a href="/controllers/dashboard/reservations/list-ctrl.php" class="py-3 nav-link navLink sidebarLink"><span><i class="bi bi-book-half px-3"></i> Reservations </span><span class="badge text-bg-danger"></span></a>
